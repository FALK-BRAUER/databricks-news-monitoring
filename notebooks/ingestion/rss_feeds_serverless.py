...
# MAGIC %md
# MAGIC # RSS Feed Ingestion (Serverless Compatible)
# MAGIC
# MAGIC This notebook fetches news articles from RSS feeds and stores them in Delta Lake.
# MAGIC Optimized for Databricks Serverless Compute.
        ...
        'news_apis': [
            {
                ...
                'feeds': [
                    ...
                    # SEA Expansion
                    {
                        ...
                        'category': 'startup',
                        'region': 'sea',
                        'countries': ['SG', 'MY', 'ID', 'TH', 'VN', 'PH', 'HK'],
                        'requires_user_agent': False
                    },
                    {
                    ...
                    {
                        'url': 'https://www.builtinsf.com/rss.xml',
                        'name': 'builtin_sf',
                        'category': 'jobs',
                        'region': 'global',
                        'countries': ['US'],
                    ...
                    {
                        'url': 'https://pitchbook.com/news/rss/all',
                        'name': 'pitchbook',
                        'category': 'vc-pe',
                        'region': 'global',
                        'countries': [],
...
def fetch_all_feeds(config: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    for feed_config in rss_feeds:
        ...
        try:
            ...
            count = len([a for a in all_articles if a['source'] == name])
...
# Note: dbutils.notebook.exit() removed for serverless compatibility
